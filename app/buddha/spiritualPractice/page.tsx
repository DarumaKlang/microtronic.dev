    ...
    <div className="container mx-auto p-8 max-w-4xl text-center">
      ...
      <div className="bg-white shadow-xl rounded-lg p-6 mb-8">
        ...
        <section className="mt-8 border-t-2 border-indigo-200 pt-6">
          ...
          <p className="italic text-gray-500 mb-4">(หันทะ มะยัง พุทธาภิถุติง กะโรมะ เส)</p>
          <p className="text-gray-800 mb-4">โย โส ตะถาคะโต,</p>
          <p className="text-gray-800 mb-4">อะระหัง,</p>
        </section>
      </div>
