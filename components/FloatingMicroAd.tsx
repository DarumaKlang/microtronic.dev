...
const FloatingMicroAd = () => {
    ...
    if (isMinimized) {
        return (
            <button
                ...
                className="fixed bottom-6 left-6 z-50 p-4 bg-blue-600 rounded-full shadow-2xl hover:scale-110 transition-transform animate-bounce"
            >
    ...
    return (
        <div className="hidden md:block fixed bottom-6 left-6 z-50 max-w-xs w-full animate-in slide-in-from-bottom duration-500">
