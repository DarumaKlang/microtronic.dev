    ...
    <nav className="bg-gray-800 p-4 text-white">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 bg-gray-800 text-white z-10 overflow-y-auto">
          ...
          <div className="flex flex-col items-start px-8 py-10 space-y-4 text-m"> {/* เปลี่ยน items-center เป็น items-start, px-8 เพื่อ padding ซ้ายขวา, py-4 เพื่อ padding บนล่าง, space-y-4 เพื่อระยะห่างระหว่างลิงก์, text-m เพื่อลดขนาดตัวอักษร */}
